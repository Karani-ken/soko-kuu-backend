...
const registerCustomer = async (req, res) => {
    ...
    try {
        ...
        res.status(201).json({ message: 'Customer registered successfully', data: result });
    } catch (err) {
...
const googleLoginCustomer = async (req, res) => {
    passport.authenticate('google', { scope: ['profile', 'email'] }, (err, profile) => {
        if (err || !profile) {
        ...
        try {
            ...
            dbHandler.getCustomerByEmail(email)
                .then(async (customer) => {
...
const deleteCustomer = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ message: 'Customer deleted successfully', data: result });
    } catch (err) {
